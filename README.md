...
<font  size=2 color=#FF0000 >**线性回归是机器学习中最基本的问题之一，通过全面了解线性回归的本质以及实现，我们可以收获关于机器学习中的一些基本思路和方法。**</font>

<font  size=4 color=#FF0000 >*1）首先我们以sklearn自带的波士顿房价数据集为对象， 载入数据：</font>
